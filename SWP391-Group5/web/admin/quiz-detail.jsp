                ...
                <div class="widget-box">
                    ...
                    <div class="widget-inner">
                        <div class="form-group col-12">
                            <label class="col-form-label-lg">Questions</label>    <c:if test="${s.isQuizTaken == false}"> <button style="float: right" type="button" class="btn btn-warning" data-toggle="modal" data-target="#add">Import question</button> </c:if>
...
<div class="modal fade" style="margin-top: 100px" id="add" tabindex="-1" aria-labelledby="addLabel" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <a href="${pageContext.request.contextPath}/web/static/template/template.xlsx" class="btn btn-secondary mt-3" download>Download Template</a>
