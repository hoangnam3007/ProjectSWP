                                ...
                                <div class="col-lg-3 col-md-4 col-sm-12 m-b30">
                                    ...
                                    <div class="profile-tabnav">
                                        <ul class="nav nav-tabs">
                                            ...
                                            <li class="nav-item">
                                                <a class="nav-link" data-toggle="tab" href="#quiz-results"><i class="ti-bookmark-alt"></i>Quiz History </a>
                                            </li>
                                            <li class="nav-item">
                                            ...
                                            <form class="edit-profile" method="POST" action="profile?email=${user.email}" id="editProfileForm">
                                                <div class="">
                                                    ...
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            <input class="form-control" name="facebook" type="text" value="${user.facebook}">
                                                            <span class="error-message text-danger" id="facebookError"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            ...
                                                            <span class="error-message text-danger" id="twitterError"></span>
                                                        </div>
                                                    </div>
                                                    <div class="form-group row">
                                                        ...
                                                        <div class="col-12 col-sm-9 col-md-9 col-lg-7">
                                                            ...
                                                            <span class="error-message text-danger" id="instagramError"></span>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="">
