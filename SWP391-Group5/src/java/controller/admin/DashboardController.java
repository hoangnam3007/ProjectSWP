...
public class DashboardController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            int newRegistrations = dashboardDAO.getNewRegistrationsCount(sqlStartDate, sqlEndDate);
            int newlyRegisteredCustomers = dashboardDAO.getNewlyRegisteredCustomersCount(sqlStartDate, sqlEndDate);
            int allCustomers = dashboardDAO.getAllCustomers().size();
