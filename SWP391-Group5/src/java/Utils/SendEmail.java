...
public class SendEmail {
    ...
    public boolean checkEmailRegister(RegisterDTO rg) {
        boolean test = false;
...
//            msg.setReplyTo(InternetAddress.parse(from, false));
    ...
    public boolean sendMailErrol(String email, String content) {
        boolean test = false;
        final String from = "Namhx0703@gmail.com";
        final String password = "satwfiyyleruqijl";
...
//            msg.setReplyTo(InternetAddress.parse(from, false));
            // Content of mail:
            msg.setText("Thank for join our course. You account is: \n"
