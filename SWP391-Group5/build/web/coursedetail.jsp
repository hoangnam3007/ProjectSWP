        ...
        <div class="section-area section-sp1">
            <div class="container">
                <div class="row d-flex flex-row-reverse">
                    <div class="col-lg-3 col-md-4 col-sm-12 m-b30" style="background-color: yellow;">
                        <form action="subjectlist" method="get">
                            <div class="widget courses-search-bx placeani" style="background-color: yellow;">
                                <div class="form-group">
                                    <div class="input-group">
                                        <form action="subjectlist" method="get">
                                            <input type="text" class="form-control" name="search" placeholder="Enter name to search" value="${param.search}">
                                            <button style="margin-top: 3px; background-color: yellow;" class="btn btn-sm" type="submit">Search</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
                            <div class="widget widget_archive" style="background-color: yellow;">
                                <h5 class="widget-title style-1">All Courses</h5>
                                <ul>
                                    <li class="active"><a href="subjectlist?search=${param.search}">All</a></li>
                                        <c:forEach var="major" items="${listM}">
                                        <li class="active"><a href="subjectlist?search=${param.search}&major=${major.major_id}">${major.major_name}</a></li>
                                        </c:forEach>
                                </ul>
                            </div>
                            <div class="widget" style="background-color: yellow;">
                                <a href="home"><img src="assets/images/adv/adv.jpg" alt=""/></a>
                            </div>
                            <div class="widget recent-posts-entry widget-courses" style="background-color: yellow;">
                                            ...
                                            <c:when test="${empty lesson}">
                                                <li>
                                                    <div class="curriculum-list-box">
                                                        <span style="color: red">This course has no lessons</span>
                                                    </div>
                                                </li>
                                            </c:when>
                                            <c:otherwise>
                                                <c:forEach items="${lesson}" var="l" varStatus="status">
                                                    <li>
                                                        ...
                                                        <c:choose>
                                                            <c:when test="${sessionScope.account == null}">
                                                                <span style="color: red">Errol to view</span>
                                                            </c:when>
                                                            <c:when test="${sessionScope.account != null && !isEnrolled}">
                                                                <span style="color: red">Errol to view</span>
                                                            </c:when>
