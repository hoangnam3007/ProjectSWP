    ...
    <div class="container-fluid">
        ...
        <div class="db-breadcrumb">
            ...
            <ul class="db-breadcrumb-list">
                ...
                <li><a href="${pageContext.request.contextPath}/admin/lesson-list">List Lesson</a></li>
            </ul>
        </div>
...
//            var lessonNamePattern = /^[a-zA-Z0-9\s]{1,50}$/;
//            if (!lessonNamePattern.test(lessonName)) {
//                document.getElementById('lesson_name_error').innerText = 'Lesson Name must be 1-50 characters long and contain only letters, numbers, and spaces.';
//                isValid = false;
//            } else {
