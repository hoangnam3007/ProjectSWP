    ...
    <main class="ttr-wrapper">
        ...
        <form action="user-list" method="get">
            <div class="row">
                ...
                <div class="feature-filters clearfix center m-b40 col-md-3" style="text-align: right; margin-top: 9px">
                    <ul class="filters">
                ...
                <div class="clearfix center m-b40 col-md-3" style="width: 120px">
                    <select class="form-control" id="roleSelect" name="role" onchange="location.href = '?search=${param.search}&status=${param.status}&role=' + this.value + '&page=1'">
                        ...
                        <option value="2" ${param.role == 2 ? 'selected' : ''}>Expect</option>
                        <option value="3" ${param.role == 3 ? 'selected' : ''}>Admin</option>
                    </select>
                </div>
